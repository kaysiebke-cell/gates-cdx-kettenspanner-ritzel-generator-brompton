...
export const i18n = {
  ...
  strings: {
    de: {
      ...
      step_both: 'STEP herunterladen (Ritzel + Bügel)',
      step_hint: 'Exakte CAD-STEP für Standardwerte — lädt Ritzel und Bügel als zwei Dateien aus dem Release.',
    ...
    en: {
      ...
      step_both: 'Download STEP (sprocket + guard)',
      step_hint: 'Exact CAD STEP for standard values — downloads sprocket and guard as two files from the release.',
