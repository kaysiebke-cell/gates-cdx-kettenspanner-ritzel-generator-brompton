...
export const i18n = {
  ...
  strings: {
    de: {
      ...
      env_hoch: 'Hochformat',
      env_quer: 'Querformat',
      env_q_voll: 'Vorschau in voller Qualität',
      env_q_sparsam: 'Vorschau sparsam gerechnet (schont Akku und Grafikkern)',
    ...
    en: {
      ...
      env_hoch: 'portrait',
      env_quer: 'landscape',
      env_q_voll: 'preview at full quality',
      env_q_sparsam: 'preview rendered sparingly (saves battery and GPU)',
