...
export const i18n = {
  ...
  strings: {
    ...
    en: {
      ...
      hint4: 'Saves material in the web between hub and tooth rim: 0 = off, otherwise the number of arms (e.g. 5). Sweep 0° = straight spokes, larger values bend them tangentially. Worthwhile from 17 teeth up — below that the free ring is too narrow and the web stays solid automatically. The spoke rounding can grow to at most half the free ring — larger values give a slot. Spokes take you off the standard values: the pre-built release files no longer match, so the cloud build is needed.',
