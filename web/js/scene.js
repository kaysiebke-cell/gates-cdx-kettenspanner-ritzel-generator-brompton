...
export function resize() {
  ...
  // Im Reiter „Druck-Empfehlungen“ ist die Vorschau ausgeblendet und damit
  // 0 x 0 groß. Ohne diese Zeile würde daraus ein Seitenverhältnis 0/0 =
  // NaN, und die Kameramatrix bliebe auch nach dem Zurückschalten kaputt.
  if (!w || !h) return;
