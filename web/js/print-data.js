// ── Druck-Empfehlungen: EINZIGE Datenquelle (Single Source of Truth) ─
// Wird von zwei Ausgaben genutzt:
//   • web/js/print.js   → rendert den App-Tab (HTML)
//   • tools/gen-readme.mjs → generiert die README-Abschnitte (Markdown)
// Werte NUR hier pflegen; danach `npm run build` (baut App + READMEs).
// Zweisprachig (de/en) in einem, damit nichts doppelt gepflegt wird.
